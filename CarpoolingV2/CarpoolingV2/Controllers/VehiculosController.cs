...
namespace CarpoolingV2.Controllers
{
    public class VehiculosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Vehiculo.Include(v => v.Usuario);
        ...
        {
            ViewData["UsuarioId"] = new SelectList(_context.Usuario, "Id", "Area");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Placa,Marca,Modelo,Color,UsuarioId")] Vehiculo vehiculo)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Usuario, "Id", "Area", vehiculo.UsuarioId);
            return View(vehiculo);
        }
